...
You should do following (also criteria for grading):
  ...
  - Test and use your newly created function by finding the results for following questions:
     - What is 48° Fahrenheit in Celsius? **==> Add your answer here:** *8.8888... (when rounded: 8.9 degrees Celsius)*
     - What about 71° Fahrenheit in Celsius? **==> Add your answer here:** *21.666... (when rounded: 21.7 degrees Celsius)*
...
You should do following (also criteria for grading):
  ...
  - Test and use your newly created function by finding the results for following questions:
     - What is class value for 16.5 degrees (Celsius)? **==> Add your answer here:** *Class 3*
     - What is the class value for +2 degrees (Celsius)? **==> Add your answer here:** *Class 1*
